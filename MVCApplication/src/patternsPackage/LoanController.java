...
public class LoanController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			out.println("Ammount Borrowed: "
					+ request.getParameter("ammountBorrowed"));
			out.println("PaymentFrequency: "
					+ this.finder(request.getParameter("paymentFrequency") + ""));
			...
			calc.setAmmountBorrowd(Integer.parseInt(request
					.getParameter("ammountBorrowed")));
			calc.setPaymentFrequency(this.finder(request
					.getParameter("paymentFrequency")));
			calc.setInterestRate(Double.parseDouble(request
			...
			request.setAttribute("LoanInfo", calc);

			RequestDispatcher dispatcher = request
					.getRequestDispatcher("LoanInputResults.jsp");
